            ...
            <View style={styles.table}> 
              ...
              {/* TableContent */} 
                <View style={styles.tableRow}> 
                    ...
                    <View style={styles.tableCol}> 
                        <Text style={styles.tableCell}>{studentName ? studentName : ''} </Text> 
                    </View>                     
                </View> 
                <View style={styles.tableRow}> 
                    <View style={styles.tableCol}> 
                    ...
                    <View style={styles.tableCol}> 
                        <Text style={styles.tableCell}>{recordType ? recordType : ''} </Text> 
                    </View>                     
                </View> 
                <View style={styles.tableRow}> 
                    <View style={styles.tableCol}> 
                    ...
                    <View style={styles.tableCol}> 
                      {segments_tx_number.map((segment, index) => (
                        <Text key={index} style={styles.tableCell}>
                          {segment}
                          {index < segments_tx_number.length - 1 && <Text>{"\n"}</Text>}
                        </Text>
                      ))}
                    </View>                     
                </View> 
